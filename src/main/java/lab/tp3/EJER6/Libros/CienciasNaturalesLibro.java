 ...
 */
public class CienciasNaturalesLibro extends DatosRegistroLibros implements Libro,Serializable{

    public CienciasNaturalesLibro(int id ,String titulo, String autores,
                                  String editorial, String anioedicion, 
                                  String ISBN, FormatoLibro formatolibro,
                                   int existencias) {
        super(id,titulo, autores, editorial,
                anioedicion, ISBN, formatolibro, existencias);
        this.tematica = Tematica.ingenieria;
        this.categoria = Categorias.ciencias_naturales;
    }
