 ...
 */
public class CienciasSocialesLibro extends DatosRegistroLibros implements Libro,Serializable{

    public CienciasSocialesLibro(int id,String titulo, 
                                 String autores, String editorial,
                                 String anioedicion, String ISBN,
        ...
        this.categoria = Categorias.ciencias_sociales;
    }
