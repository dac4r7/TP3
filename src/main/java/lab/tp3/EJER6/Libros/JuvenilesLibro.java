 ...
 */
public class JuvenilesLibro extends DatosRegistroLibros implements Libro , Serializable{

    public JuvenilesLibro(int id ,String titulo, String autores, 
   ...
   this.categoria = Categorias.juveniles;
  }
