 ...
 */
public class MisterioLibro extends DatosRegistroLibros implements Libro ,Serializable{

    public MisterioLibro(int id ,String titulo, String autores,
   ...
   this.categoria = Categorias.misterio;
   }
