 ...
 */
public class IngenieriaLibro extends DatosRegistroLibros implements Libro, Serializable{
    
    public IngenieriaLibro( int id ,String titulo,
   ...
   this.categoria = Categorias.ingenieria;
   }
