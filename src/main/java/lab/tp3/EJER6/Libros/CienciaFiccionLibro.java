 ...
 */
public class CienciaFiccionLibro extends DatosRegistroLibros implements Libro ,Serializable{

    public CienciaFiccionLibro(int id ,String titulo, String autores,
    ...
    this.categoria = Categorias.ciencia_ficción;   
    }
