 ...
 */
public class PolicialesLibro extends DatosRegistroLibros implements Libro , Serializable{

    public PolicialesLibro( int id, String titulo, String autores,
                            String editorial, String anioedicion,
                            String ISBN, FormatoLibro formatolibro, int existencias) {
